...
public class Constants {
    ...
    public static String ALARM_PREFERENCE_KEY = "firebase_alarm_notification";
    public static String ALARM_ASSET_CURRENT_ID = "firebase_alarm_current_id";
    public static int NOTIFICATION_PERMISSION_REQUEST_CODE = 777;
}
